"""Utilities to fetch the RecoDAI LUC Scientific Image Forgery Detection dataset.
...
Example:
    ...
    python -m competitions.recodai_luc_scientific_image_forgery_detection.src.data.download \
        --download-dir data/raw --extract
