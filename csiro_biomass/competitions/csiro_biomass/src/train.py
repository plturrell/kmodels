...
try:  # Optional; fails under Python <3.10 due to Kaggle SDK typing
    from .utils.leaderboard import compare_leaderboard, print_leaderboard_summary
except Exception:  # pragma: no cover - graceful degradation for training-only usage
    compare_leaderboard = None

    def print_leaderboard_summary(*args, **kwargs) -> None:
        LOGGER.warning("Leaderboard utilities unavailable; skipping summary.")
...
def main(argv: Optional[Iterable[str]] = None) -> int:
    ...
    if args.compare_leaderboard and compare_leaderboard is not None:
    ...
    elif args.compare_leaderboard:
        LOGGER.warning("Leaderboard comparison requested but utilities are unavailable on this runtime.")
    return 0
